...
class CustomLlamaAttention(LlamaAttention):
    ...
    def forward(
            ...
            head_mask: Optional[list] = None,
            mask_type: Optional[str] = None,
            scale_factor: Optional[float] = None,
            mask_para: Optional[bool] = False,
        ...
        if head_mask is not None and (mask_para is False or mask_para is None):
            for i in range(self.config.num_attention_heads):
                if (self.layer_idx, i) in head_mask:
                    if mask_type == 'scale_mask':
                        query_states[:, i, :, :] *= scale_factor
                    elif mask_type == 'mean_mask':
                        query_states[:, i, :, :] = query_states[:, :, :, :].mean(dim=1,keepdim=False)
...
class CustomQwen2ForCausalLM(CustomLlamaModelForCausalLM):
